    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Botcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and botcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Botcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Botcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Botcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a botcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Botcoin Core help message to get a list with possible Botcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Botcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Botcoin Core"); // default title
