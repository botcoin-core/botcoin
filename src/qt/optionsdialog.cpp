    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BOTCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("BOTCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BOTCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BOTCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BOTCOIN-traditional"), QVariant("trad"));
