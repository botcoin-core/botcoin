    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Botcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Botcoin Core"));
...
All the Botcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BOTCOIN, 0.1 BOTCOIN, 1 BOTCOIN and 10 BOTCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://botcoin-core.atlassian.net/wiki/display/DOC/PrivateSend\">https://botcoin-core.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Botcoin Core is shutting down...") + "<br /><br />" +
