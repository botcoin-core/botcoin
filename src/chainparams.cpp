...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("botcoin.org", "dnsseed.botcoin.org"));
        vSeeds.push_back(CDNSSeedData("botcoindot.io", "dnsseed.botcoindot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("botcoin-core.io", "dnsseed.botcoin-core.io"));

        // Botcoin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Botcoin script addresses start with '7'
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("botcoindot.io",  "testnet-seed.botcoindot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        // Testnet Botcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Botcoin script addresses start with '8' or '9'
...
public:
    CRegTestParams() {
        ...
        // Regtest Botcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Botcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
