...
#define BOOST_TEST_MODULE Botcoin Test Suite

#include "test_botcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_botcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
