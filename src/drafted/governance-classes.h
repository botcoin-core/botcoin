 ...
 *
 *   // network
 *   CBotcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.botcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBotcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBotcoinNetwork(UniValue objIn)
    {
...
// // can be under: BotcoinNetwork
// //   -- signature requirements : Key1(User)
// class CBotcoinNetworkVariable : public CGovernanceObject
// {
// private:
