...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BotcoinNetwork") type = BotcoinNetwork;
    if(strType == "BotcoinNetworkVariable") type = BotcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BotcoinNetwork) s = "BotcoinNetwork";
    if(type == BotcoinNetworkVariable) s = "BotcoinNetworkVariable";
