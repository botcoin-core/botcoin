...
Botcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Botcoin Core, where everyone uses
...
pay attention to for reviewers of Botcoin Core code.

General Botcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Botcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
