...
Only requiring some minor changes is botcoin.cpp.
...
Changes to botcoin.cpp
----------------------
botcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
