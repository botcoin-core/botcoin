...
This mechanism has been integrated into Bitcore-Node-Botcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/botcoin-core/insight-api-botcoin#web-socket-api](https://github.com/botcoin-core/insight-api-botcoin#web-socket-api)
* API: [https://github.com/botcoin-core/insight-api-botcoin#instantsend-transactions](https://github.com/botcoin-core/insight-api-botcoin#instantsend-transactions)
...
By default, the Botcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Botcoin Core daemon:
